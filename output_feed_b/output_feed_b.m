function [xdot]= output_feed_b(t,x)
%% desired trajectory
...
pi2=[x(41) x(42)];
dpi1=pi2/ep;
dpi2=(-lamd1.*pi2-pi1+[x(1) x(2)])/ep;
e=[x(1) x(2)]-qd;
alp1=-[k1*e(1) k1*e(2)]+dqd;
e2=(pi2/ep)-alp1;  e=e';
dalp1=(-b^2*k1*[x(3) x(4)]+2*(norm(e))^2*[x(3) x(4)]*k1+(norm(e))^2*k1*[x(3) x(4)])*[x(3) x(4)]'+qd+(b^2*k1*dqd-2*(norm(e))^2*dqd*k1-(norm(e))^2*k1*dqd)*(norm(qd))^2;
...
torque= -[e(1)/(b^2-e(1)^2);e(2)/(b^2-e(2)^2)]-k2.*e2'+(W'*S + W_tau'*S_tau)';
% updating laws
...
xdot=[x(3);x(4);qdotdot(1);qdotdot(2);
    ...
    dW(1:16); dW_tau(1:16);dpi1(1);dpi1(2);dpi2(1);dpi2(2)
    ];
